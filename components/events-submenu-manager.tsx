...
interface EventsSubmenuManagerProps {
  initialItems: EventsSubmenuItem[]
}

export function EventsSubmenuManager({ initialItems }: EventsSubmenuManagerProps) {
  const router = useRouter()
  const { toast } = useToast()
  const [items, setItems] = useState<EventsSubmenuItem[]>(initialItems)
